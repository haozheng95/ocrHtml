...
from aiapp.chinese_ocr.ctpn.lib.utils.timer import Timer
from aiapp.chinese_ocr.ctpn.lib.fast_rcnn.config import cfg
from aiapp.chinese_ocr.ctpn.lib.fast_rcnn.test import  test_ctpn
from aiapp.chinese_ocr.ctpn.lib.networks.factory import get_network
from aiapp.chinese_ocr.ctpn.lib.text_connector.detectors import TextDetector
from aiapp.chinese_ocr.ctpn.lib.text_connector.text_connect_cfg import Config as TextLineCfg
...
def load_tf_model():
    # load config file
    cfg.TEST.checkpoints_path = os.path.join(base_path, 'checkpoints')
